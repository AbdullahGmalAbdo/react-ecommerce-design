            ...
            <div className="user-address-card my-3 px-2">
                <Row className="d-flex justify-content-between pt-2">
                    <Col xs="6" className="d-flex">
                        ...
                        <div className="p-1 item-delete-edit"> عبدالله</div>
                    </Col>
                ...
                <Row className="">
                    <Col xs="12" className="d-flex">
                        ...
                        <div className="p-1 item-delete-edit">01060853801</div>
                    </Col>
                </Row>
                <Row className="">
                    <Col xs="12" className="d-flex">
                        <div className="p-2">الايميل:</div>
                        <div className="p-1 item-delete-edit">abdallahcs222@gmail.com</div>
                    </Col>
                </Row>
                <Row className="mt-5">
